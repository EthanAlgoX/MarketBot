import type { ChannelOnboardingAdapter, MarketBotConfig, WizardPrompter } from "marketbot/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.marketbot.ai/channels/mattermost",
    ].join("\n"),
