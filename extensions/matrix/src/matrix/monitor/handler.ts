...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("marketbot/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("marketbot/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "MarketBot: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
