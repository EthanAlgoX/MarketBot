...
import { addWildcardAllowFrom, DEFAULT_ACCOUNT_ID, formatDocsLink } from "marketbot/plugin-sdk";
...
function setFeishuDmPolicy(cfg: MarketBotConfig, dmPolicy: DmPolicy): MarketBotConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: MarketBotConfig, allowFrom: string[]): MarketBotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: MarketBotConfig, groupAllowFrom: string[]): MarketBotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
