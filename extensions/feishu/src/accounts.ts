...
import { DEFAULT_ACCOUNT_ID } from "marketbot/plugin-sdk";
...
export function listFeishuAccountIds(_cfg: MarketBotConfig): string[] {
  return [DEFAULT_ACCOUNT_ID];
}

export function resolveDefaultFeishuAccountId(_cfg: MarketBotConfig): string {
  return DEFAULT_ACCOUNT_ID;
}

export function listEnabledFeishuAccounts(cfg: MarketBotConfig): ResolvedFeishuAccount[] {
