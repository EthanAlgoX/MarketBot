...
import { removeAckReactionAfterReply, shouldAckReaction } from "marketbot/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/marketbot") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
