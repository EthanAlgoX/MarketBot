import type { LineChannelData, MarketBotPluginApi, ReplyPayload } from "marketbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: MarketBotPluginApi): void {
  api.registerCommand({
    name: "card",
