...
if [[ -z "$version_content" ]]; then
  echo "<h2>MarketBot $VERSION</h2>"
  echo "<p>Latest MarketBot update.</p>"
  echo "<p><a href=\"https://github.com/marketbot/marketbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
