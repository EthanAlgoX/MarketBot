...
# Output:
# - dist/MarketBot.app
# - dist/MarketBot-<version>.zip
# - dist/MarketBot-<version>.dmg
...
APP="$ROOT_DIR/dist/MarketBot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/MarketBot-$VERSION.zip"
DMG="$ROOT_DIR/dist/MarketBot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/MarketBot-$VERSION.notary.zip"
