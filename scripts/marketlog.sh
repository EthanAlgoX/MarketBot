...
show_usage() {
    cat << EOF
clawlog - MarketBot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View MarketBot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    MarketBot logs flow through the macOS unified log (subsystem: ai.marketbot).
