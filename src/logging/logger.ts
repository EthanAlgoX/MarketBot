...
export const DEFAULT_LOG_DIR = "/tmp/marketbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "marketbot.log"); // legacy single-file path

const LOG_PREFIX = "marketbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: MarketBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => MarketBotConfig;
      };
