...
import { discoverMarketBotPlugins } from "../../plugins/discovery.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { MarketBotPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MarketBotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["MARKETBOT_PLUGIN_CATALOG_PATHS", "MARKETBOT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<MarketBotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: MarketBotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: MarketBotPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverMarketBotPlugins({ workspaceDir: options.workspaceDir });
