...
export type ChannelAgentToolFactory = (params: { cfg?: MarketBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MarketBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: MarketBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: MarketBotConfig }) => boolean;
  supportsCards?: (params: { cfg: MarketBotConfig }) => boolean;
