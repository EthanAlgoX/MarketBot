...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.MARKETBOT_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: MarketBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: MarketBotConfig): string {
...
export function listEnabledTelegramAccounts(cfg: MarketBotConfig): ResolvedTelegramAccount[] {
