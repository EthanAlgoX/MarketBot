...
function resolveAnthropicDefaultAuthMode(cfg: MarketBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MarketBotConfig): MarketBotConfig {
...
export function applyTalkApiKey(config: MarketBotConfig): MarketBotConfig {
...
export function applyModelDefaults(cfg: MarketBotConfig): MarketBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MarketBotConfig): MarketBotConfig {
...
export function applyLoggingDefaults(cfg: MarketBotConfig): MarketBotConfig {
...
export function applyContextPruningDefaults(cfg: MarketBotConfig): MarketBotConfig {
...
export function applyCompactionDefaults(cfg: MarketBotConfig): MarketBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
