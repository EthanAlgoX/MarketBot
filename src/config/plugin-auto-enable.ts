...
function isTelegramConfigured(cfg: MarketBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: MarketBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: MarketBotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: MarketBotConfig): boolean {
...
function isIMessageConfigured(cfg: MarketBotConfig): boolean {
...
function isWhatsAppConfigured(cfg: MarketBotConfig): boolean {
...
function isGenericChannelConfigured(cfg: MarketBotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: MarketBotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: MarketBotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: MarketBotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: MarketBotConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: MarketBotConfig, pluginId: string): MarketBotConfig {
...
function enablePluginEntry(cfg: MarketBotConfig, pluginId: string): MarketBotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
