...
export type ConfigSchema = ReturnType<typeof MarketBotSchema.toJSONSchema>;
...
const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.web.fetch.strategy": "Web Fetch Strategy",
  "tools.web.fetch.maxChars": "Web Fetch Max Chars",
  "tools.web.fetch.timeoutSeconds": "Web Fetch Timeout (sec)",
  "tools.web.fetch.cacheTtlMinutes": "Web Fetch Cache TTL (min)",
  "tools.web.fetch.maxRedirects": "Web Fetch Max Redirects",
  "tools.web.fetch.userAgent": "Web Fetch User-Agent",
  "tools.web.fetch.firecrawl.proxy": "Firecrawl Proxy Mode",
  "tools.web.fetch.firecrawl.storeInCache": "Firecrawl Store in Cache",
...
const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when MarketBot writes the config.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /marketbot).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $MARKETBOT_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "tools.web.fetch.strategy":
    'Execution strategy for web_fetch ("fast", "waterfall", "race"; default: "waterfall").',
  ...
  "tools.web.fetch.readability":
    "Use Readability to extract main content from HTML before configured fallbacks.",
  ...
  "tools.web.fetch.firecrawl.proxy":
    'Firecrawl proxy mode ("auto", "basic", "stealth"; default: "auto").',
  "tools.web.fetch.firecrawl.storeInCache":
    "Allow Firecrawl provider-side cache reuse when available (default: true).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.marketbot/memory/{agentId}.sqlite).",
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `marketbot plugins update` to locate install sources).",
  "plugins.installs.*.source": 'Install source ("npm", "archive", or "path").',
  "plugins.installs.*.spec": "Original npm spec used for install (if source is npm).",
  "plugins.installs.*.sourcePath": "Original archive/path used for install (if any).",
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.marketbot/extensions/<id>).",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/marketbot",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.list[].identity.avatar": "avatars/marketbot.png",
};
...
function buildBaseConfigSchema(): ConfigSchemaResponse {
  ...
  const schema = MarketBotSchema.toJSONSchema({
    target: "draft-07",
    unrepresentable: "any",
  });
  schema.title = "MarketBotConfig";
