...
export const portfolioAddTool: ToolSpec = {
    name: "portfolio_add",
...
export const portfolioRemoveTool: ToolSpec = {
...
export const portfolioStatusTool: ToolSpec = {
...
export default [portfolioAddTool, portfolioRemoveTool, portfolioStatusTool];
