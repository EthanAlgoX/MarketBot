import type { ToolSpec, ToolContext, ToolResult } from "../../tools/types.js";
...
export const webSearchTool: ToolSpec = {
    ...
    run: async (context: ToolContext): Promise<ToolResult> => {
        ...
        try {
            ...
            const provider = typeof input?.provider === "string" && (input.provider === "browser" || input.provider === "perplexity")
                ? input.provider
