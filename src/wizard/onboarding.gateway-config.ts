...
import type { GatewayBindMode, GatewayTailscaleMode, MarketBotConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      [
        "Docs:",
        "https://docs.marketbot.ai/gateway/tailscale",
        "https://docs.marketbot.ai/web",
      ].join("\n"),
      "Tailscale",
    );
