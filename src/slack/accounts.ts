...
export function listSlackAccountIds(cfg: MarketBotConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: MarketBotConfig): string {
...
function mergeSlackAccountConfig(cfg: MarketBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MarketBotConfig): ResolvedSlackAccount[] {
