...
export const normalizePluginsConfig = (
  config?: MarketBotConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: MarketBotConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: MarketBotConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: MarketBotConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
