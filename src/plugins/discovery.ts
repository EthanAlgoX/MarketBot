...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @marketbot/voice-call -> voice-call).
...
export function discoverMarketBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".marketbot", "extensions")];
