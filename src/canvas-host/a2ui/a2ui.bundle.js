...
var MarketBotA2UIHost = class extends i$6 {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = i$9`
    ...
    .status {
      ...
      border: 1px solid rgba(15, 23, 42, 0.12);
      color: ${r$11(uiText)};
      font: 12px/1.2 ${r$11(baseFont)};
      pointer-events: none;
      backdrop-filter: blur(${r$11(statusBlur)}) saturate(140%);
      -webkit-backdrop-filter: blur(${r$11(statusBlur)}) saturate(140%);
