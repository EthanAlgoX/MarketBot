...
export const A2UI_PATH = "/__marketbot__/a2ui";

export const CANVAS_HOST_PATH = "/__marketbot__/canvas";

export const CANVAS_WS_PATH = "/__marketbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.marketbotCanvasA2UIAction.postMessage(...)
  // - Android: window.marketbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["marketbotCanvasA2UIAction"];
  ...
  globalThis.MarketBot = globalThis.MarketBot ?? {};
  globalThis.MarketBot.postMessage = postToNode;
  globalThis.MarketBot.sendUserAction = sendUserAction;
  globalThis.marketbotPostMessage = postToNode;
  globalThis.marketbotSendUserAction = sendUserAction;
