...
import { resolveMarketBotDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveMarketBotAgentDir();
  await ensureMarketBotModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createMarketBotCodingTools({
      exec: {
    ...
    const docsPath = await resolveMarketBotDocsPath({
      workspaceDir: effectiveWorkspace,
