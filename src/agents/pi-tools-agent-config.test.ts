...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: MarketBotConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/marketbot-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createMarketBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createMarketBotCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createMarketBotCodingTools({
      config: cfg,
    ...
    const defaultTools = createMarketBotCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createMarketBotCodingTools({
      config: cfg,
    ...
    const bobTools = createMarketBotCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createMarketBotCodingTools({
      config: cfg,
