...
describe("createMarketBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createMarketBotCodingTools({
      config,
    ...
    const anthropicTools = createMarketBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createMarketBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createMarketBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
