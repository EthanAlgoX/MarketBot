  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "marketbot.sandbox=1",
        "--label",
        "marketbot.sessionKey=main",
        "--label",
        "marketbot.createdAtMs=1700000000000",
        "--label",
        "marketbot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
