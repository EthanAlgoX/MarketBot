...
function resolveMentionPatterns(cfg: MarketBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MarketBotConfig | undefined, agentId?: string): RegExp[] {
