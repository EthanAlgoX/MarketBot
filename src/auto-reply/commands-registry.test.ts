...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@marketbot", { botUsername: "marketbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@marketbot args", {
        botUsername: "marketbot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@marketbot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "marketbot" })).toBe(
      "/help@otherbot",
    );
  });
