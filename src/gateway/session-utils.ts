...
import { type MarketBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: MarketBotConfig): string[] {
...
export function listAgentsForGateway(cfg: MarketBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: MarketBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: MarketBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: MarketBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: MarketBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: MarketBotConfig): GatewaySessionsDefaults {
