...
import type { MarketBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: MarketBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: MarketBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: MarketBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: MarketBotConfig) => void;
  log: {
