...
export function listWhatsAppAuthDirs(cfg: MarketBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MarketBotConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: MarketBotConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: MarketBotConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: MarketBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MarketBotConfig): ResolvedWhatsAppAccount[] {
