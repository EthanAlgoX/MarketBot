...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveMarketBotAgentDir();
...
export const CEREBRAS_DEFAULT_MODEL_REF = "cerebras/llama3.1-70b";
export const XAI_DEFAULT_MODEL_REF = "xai/grok-beta";
