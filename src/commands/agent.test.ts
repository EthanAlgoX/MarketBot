...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "marketbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<MarketBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<MarketBotConfig["telegram"]>>,
