...
function resolveConfiguredModelRaw(cfg: MarketBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: MarketBotConfig): string[] {
...
export function applyPrimaryModel(cfg: MarketBotConfig, model: string): MarketBotConfig {
...
export function applyModelAllowlist(cfg: MarketBotConfig, models: string[]): MarketBotConfig {
  const defaults = cfg.agents?.defaults;
