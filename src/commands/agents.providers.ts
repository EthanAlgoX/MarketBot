...
function resolveDefaultAccountId(cfg: MarketBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: MarketBotConfig): boolean {
...
export function summarizeBindings(cfg: MarketBotConfig, bindings: AgentBinding[]): string[] {
