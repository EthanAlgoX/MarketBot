...
const ensureMarketBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveMarketBotAgentDir = vi.fn().mockReturnValue("/tmp/marketbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/marketbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureMarketBotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveMarketBotAgentDir,
}));
