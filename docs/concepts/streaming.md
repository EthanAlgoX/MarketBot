...
MarketBot has two separate “streaming” layers:
...
When block streaming is enabled, MarketBot can **merge consecutive block chunks**
...
When draft streaming is active, MarketBot disables block streaming for that reply to avoid double-streaming.
