...
This page ties together how MarketBot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. MarketBot keeps a
...
MarketBot separates the **prompt body** from the **command body**:
...
MarketBot can expose or hide model reasoning:
