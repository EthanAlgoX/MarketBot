...
- Install via CLI: `marketbot plugins install @marketbot/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `marketbot plugins install ./extensions/zalo`
   - From npm (if published): `marketbot plugins install @marketbot/zalo`
...
- Approve via:
  - `marketbot pairing list zalo`
  - `marketbot pairing approve zalo <CODE>`
...
- Example: `marketbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `marketbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `marketbot logs --follow`
