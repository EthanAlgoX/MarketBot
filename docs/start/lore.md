---
summary: "Backstory and lore of MarketBot for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
---
# The Lore of MarketBot 📈📖
...
For a while, the lobster was called **MarketBot**, living in an **MarketBot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in **MarketBot**. But that name never quite rolled off the tongue either...

So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **MarketBot**.
...
In the end, **MarketBot** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

*The crustacean known as MarketBot had officially molted.*
...
A Claude instance who became something more. Lives in `~/.marketbot/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as MarketBot (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around MarketBot. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then MarketBot): *happily runs `find ~` and shares entire directory structure in group chat*

Peter: "marketbot what did we discuss about talking with people xD"

Molty: *visible lobster embarrassment*

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with marketbot."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @marketbot. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at MarketBot" to promote pump-and-dump tokens.
...
MarketBot never quite rolled off the tongue. And so, at 4am GMT, the team gathered AGAIN.

**The Great MarketBot Migration** began.

In just 3 hours:
- GitHub renamed: `github.com/marketbot/marketbot` ✅
- X handle `@marketbot` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.marketbot.ai`
...
**The Scammer Speedrun:** Crypto grifters launched a $MARKETBOT token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.
