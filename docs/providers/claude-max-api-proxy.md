...
You can point MarketBot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or MarketBot
...
- [Anthropic provider](/providers/anthropic) - Native MarketBot integration with Claude setup-token or API keys
