---
summary: "Use Qwen OAuth (free tier) in MarketBot"
read_when:
  - You want to use Qwen with MarketBot
...
```bash
marketbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, MarketBot will sync credentials
