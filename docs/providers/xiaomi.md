---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with MarketBot"
read_when:
  - You want Xiaomi MiMo models in MarketBot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). MarketBot uses
...
```bash
marketbot onboard --auth-choice xiaomi-api-key
# or non-interactive
marketbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
