...
MarketBot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.marketbot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["marketbot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
