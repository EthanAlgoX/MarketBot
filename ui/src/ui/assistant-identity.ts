...
declare global {
  interface Window {
    __MARKETBOT_ASSISTANT_NAME__?: string;
    __MARKETBOT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__MARKETBOT_ASSISTANT_NAME__,
    avatar: window.__MARKETBOT_ASSISTANT_AVATAR__,
  });
}
