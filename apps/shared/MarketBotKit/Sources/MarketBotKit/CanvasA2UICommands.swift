...
public enum MarketBotCanvasA2UICommand: String, Codable, Sendable {
...
public struct MarketBotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MarketBotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
