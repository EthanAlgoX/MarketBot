...
public typealias MarketBotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MarketBotPlatformImage = UIImage
#endif

public struct MarketBotChatUsageCost: Codable, Hashable, Sendable {
...
public struct MarketBotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MarketBotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MarketBotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MarketBotChatMessageContent: Codable, Hashable, Sendable {
...
public struct MarketBotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MarketBotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MarketBotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MarketBotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MarketBotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MarketBotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MarketBotChatMessageContent].self, forKey: .content) {
...
public struct MarketBotChatHistoryPayload: Codable, Sendable {
...
public struct MarketBotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MarketBotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MarketBotSessionPreviewItem]
}

public struct MarketBotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MarketBotSessionPreviewEntry]

    public init(ts: Int, previews: [MarketBotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MarketBotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MarketBotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MarketBotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MarketBotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MarketBotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MarketBotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MarketBotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: MarketBotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct MarketBotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
