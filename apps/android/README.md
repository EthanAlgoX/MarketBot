## MarketBot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_marketbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm marketbot gateway --port 18789 --verbose
```
