...
final class ScreenController {
    ...
    /// Callback invoked when an marketbot:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = MarketBotKitResources.bundle
...
/// Handles navigation policy to intercept marketbot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept marketbot:// deep links.
        if url.scheme?.lowercased() == "marketbot" {
