...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: MarketBotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: MarketBotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: MarketBotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
