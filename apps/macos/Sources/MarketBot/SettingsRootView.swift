...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .marketbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? MarketBotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? MarketBotPaths.stateDirURL.path
...
extension Notification.Name {
    static let marketbotSelectSettingsTab = Notification.Name("marketbotSelectSettingsTab")
}
