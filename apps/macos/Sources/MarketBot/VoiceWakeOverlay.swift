...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.marketbot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other MarketBot windows, but below the system’s pop-up menus.
