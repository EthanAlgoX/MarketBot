...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/marketbot/marketbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/marketbot/marketbot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://marketbot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "MarketBotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "MarketBotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "MarketBotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "MarketBotGitCommit") as? String) ??
            "unknown"
    }
