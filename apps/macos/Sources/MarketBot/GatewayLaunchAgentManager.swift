...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.marketbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".marketbot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.marketbotCommand(
            subcommand: "gateway",
