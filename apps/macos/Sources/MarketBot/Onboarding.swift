...
enum UIStrings {
    static let welcomeTitle = "Welcome to MarketBot"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: MarketBotOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: MarketBotChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g marketbot@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: MarketBotChatViewModel(
