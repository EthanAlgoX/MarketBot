...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: MarketBotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": MarketBotProtocol.AnyCodable("start"),
                "name": MarketBotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
