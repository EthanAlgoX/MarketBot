...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.marketbot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MarketBotConfigFile.defaultWorkspaceURL() }
