...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MarketBotConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MarketBotConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = MarketBotConfigFile.loadDict()
            ...
            MarketBotConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/marketbot"
        state.remoteCliPath = ""
        return state
    }
}
