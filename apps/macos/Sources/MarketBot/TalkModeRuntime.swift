...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.marketbot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.marketbot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MarketBotChatMessage] = messages.compactMap { item in
